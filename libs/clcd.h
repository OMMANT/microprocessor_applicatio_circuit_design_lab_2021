...
#define CLCD_MAX_CHAR 16

#define CLCD_DD 1
#define CLCD_CG 0

#define CLCD_INCREASE 1
#define CLCD_DECREASE 0
#define CLCD_NOSHIFT 0

#define CLCD_MAX_GRADE 4
#define CLCD_GRADE_LENGTH 8

#define CLCD_BLOCK_TYPES    5
#define CLCD_TYPE_LENGTH    8
